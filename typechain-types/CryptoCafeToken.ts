...
export interface CryptoCafeTokenInterface extends utils.Interface {
  functions: {
...
export interface CryptoCafeToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CryptoCafeTokenInterface;
